1. ==== .env 파일을 만들고 아래코드를 입력하세요 ====
   
3. OPENAI_API_KEY="키를 입력하세요"
4. TAVILY_API_KEY="키를 입력하세요"
...
16.   (추가로 필요한 라이브러리가 자동으로 설치 될 수 있습니다)
      
18.  ==== 프롬프트에서 "python api.py" 실행 ====
     (GPU VRAM이 최소3GB가 필요합니다)

==== http://localhost:(할당받은 포트번호) 접속 시 동일한 화면을 볼 수 있습니다. ====
